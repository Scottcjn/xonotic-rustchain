...
NAME = "rustchain_antiquity_relay"


def test_antiquity_relay_delivery_files_exist():
...
def test_antiquity_relay_mapinfo_and_entities_are_playable():
...
def test_antiquity_relay_bsp_and_levelshot_have_expected_headers():
