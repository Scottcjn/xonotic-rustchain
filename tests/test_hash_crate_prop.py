...
class HashCratePropTest(unittest.TestCase):
    def test_required_bounty_files_exist(self):
        required = [
            ...
            "LICENSE",
            "hash_crate_iron.tga",
            "hash_crate_panels.tga",
            "hash_crate_glow.tga",
            "hash_crate_warning.tga",
        ]
    ...
    def test_skin_maps_all_model_materials(self):
        ...
        for material in ("crate_iron", "hash_panels", "rtc_glow", "warning_stripe"):
    ...
    def test_readme_identifies_distinct_wishlist_item(self):
        ...
        self.assertIn("hash crate", readme.lower())
